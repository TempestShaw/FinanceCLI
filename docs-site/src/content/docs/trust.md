...
Never claim live market data without provider/source and date/timestamp fields when available. Treat Yahoo, FMP, SEC, GDELT, transcript pages, and company IR pages as source-specific records, not ground truth.
